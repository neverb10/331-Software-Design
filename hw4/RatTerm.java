...
public final class RatTerm {
	...
	public double eval(double d) {
		...
		return Math.pow(d, this.expt) * getCoeff().doubleValue();
	}
	...
	public RatTerm add(RatTerm arg) {
		if (this.getExpt() != arg.getExpt() && !(this.isZero() || this.isNaN() || arg.isZero() || arg.isNaN())) {
	...
	public RatTerm mul(RatTerm arg) {
		...
		return new RatTerm(this.getCoeff().mul(arg.getCoeff()), this.getExpt() + arg.getExpt());
	}
	...
	public RatTerm div(RatTerm arg) {
		...
		return new RatTerm(this.getCoeff().div(arg.getCoeff()), this.getExpt() - arg.getExpt());
	}
	...
	public RatTerm differentiate() {
		...
		return new RatTerm(new RatNum(this.getExpt()).mul(this.getCoeff()), this.getExpt() - 1);
	}
	...
	public RatTerm antiDifferentiate() {
		...
		return new RatTerm(this.getCoeff().div(new RatNum(this.getExpt() + 1)), this.getExpt() + 1);
	}
