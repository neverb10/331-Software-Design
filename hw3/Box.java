 ...
 * finite volume. Once a box is full, a client cannot put in more Balls.f
 */
public class Box implements Iterable<Ball> {
    ...
    public Iterator<Ball> getBallsFromSmallest() {
    	List<Ball> containerSub = ballContainer.getContentsList();
    	Collections.sort(containerSub, new Comparator<Ball>() {
